      ...
      switch (commandNumber)
      {
         ...
         case SM_COMPUTE_ALL_SENSOR_PARTIALS1:
         {
            ...
            {              
               ...
               else if(param_array[i] == "NON_ADJUSTABLE")
               {
         ...
         case SM_GET_CROSS_COVARIANCE_MATRIX:
         {
			...
			if(param_array.size() > 0)
            {
               ...
               else if(param_array[0] == "NON_ADJUSTABLE")
               {
                  pSet = param::NON_ADJUSTABLE;
               }
            }
		 ...
		 //----- CASE getCorrelationModel
         case SM_GET_CORRELATION_MODEL:
         {
            initCase();
            
            if(debugFlag)
            {
               cout << endl << "  vts - Calling getCorrelationModel" << endl;
               cout << "    Passing values are: " << endl;
               cout << "      NONE" << endl;
            }
